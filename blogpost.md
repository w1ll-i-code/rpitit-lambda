...
With our boolean values in place, let's do some logic with logical `or` and `and`. If we write
...
With this we delegate the work to actually know the type we want to print out to the compiler. We can do
